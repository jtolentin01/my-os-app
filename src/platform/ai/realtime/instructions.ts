export const buildRealtimeInstructions = (input: {
  ...
  const lines = [
    ...
    "Use tools when they help complete a request about Diet, Notes, Money, or personal memory.",
    ...
    "When asked about money, spending, income, expenses, or logging purchases, use the Money tools.",
