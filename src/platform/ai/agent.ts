...
const buildInstructions = (input: {
  ...
  const lines = [
    ...
    "For new cookable dishes, use create_menu_item or create_menu_items (prefer estimateNutrition true unless the user gave exact macros). Include ingredients and instructions when known; estimation can fill a simple recipe too.",
