...
export const OfflineMessage = ({
  ...
  return (
    <div className="mx-auto flex w-full max-w-lg flex-col items-center gap-3 rounded-xl border border-dashed border-border/80 bg-card px-6 py-16 text-center">
